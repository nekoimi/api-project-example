...
public abstract class BaseServiceImpl<M extends BaseMapper<E>, E> implements BaseService<E> {
    ...
    @Transactional(readOnly = true)
    @Override
    public IPage<E> listPaginator(IPage<E> page, Wrapper<E> wrapper) {
        return mapper.selectPage(page, wrapper);
    }

    @Transactional(readOnly = true)
    @Override
    public IPage<Map<String, Object>> listMapPaginator(IPage<Map<String, Object>> page, Wrapper<E> wrapper) {
